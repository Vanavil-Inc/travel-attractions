...
export declare class TableDataSource<T> extends DataSource<TableElement<T>> {
   ...
   */
     ...
     * @param source
     */
    private existsNewElement(source);
    /**
     ...
     */
    private getRowIdFromIndex(index, count);
    /**
     ...
     * @param source
     */
    private getIndexFromRowId(id, source);
    /**
     ...
     */
    private updateRowIds(initialIndex, source);
    /**
     * Get the data from the rows.
     * @param rows Rows to extract the data.
     */
    private getDataFromRows(rows);
    /**
